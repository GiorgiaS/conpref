...
class DeviceJava:
    ...
    def setCipherFile(self, algo): 
        ...
        # newPath = "client/client_cipher.txt"
    ...
    def computeCardinalityBloom(self, algo):
        if(algo == "revECCUnbPSICA"):
            cardinality = self.client.ECC_PSI_Rev_cardinality_bloom()
        else: # if algo = ECCUnbPSICA or UnbPSICA
    ...
    def decryptCipher(self, algo):
        ...
        if (algo == "ECCUnbPSICA"):
            ...
            self.client.PSI_Unbalanced_decrypt_cypher()
